...
function gerenciaGame(){
	...
	if(contBombas<=0){
		...
		telaMsg.style.backgroundImage="url('../fiap-game/Imagens/vitoria.png')";
	...
	if(vidaPlaneta<=0){
		...
		telaMsg.style.backgroundImage="url('../fiap-game/Imagens/gameover.png')";
...
function inicia(){
	...
	telaMsg.style.backgroundImage="url('../fiap-game/Imagens/ativo7.png')";
	telaMsg.style.display="block";
